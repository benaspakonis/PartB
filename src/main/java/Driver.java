...
public class Driver {
	...
	public static void printStudentInfo(Student student) {
		String info = STUDENT_INFO + NEW_LINE + LINE_BREAK + NEW_LINE + NAME + COLON + student.getName() + NEW_LINE
				+ AGE + COLON + student.getAge() + NEW_LINE + USERNAME + COLON + student.getUsername() + NEW_LINE + DOB
				+ COLON + student.getDOB() + NEW_LINE + COURSES + COLON + OPENING_BRACKET + NEW_LINE;
	...
	public static void printModuleInfo(Module module) {
		String info = MODULE_INFO + NEW_LINE + LINE_BREAK + NEW_LINE + TITLE + COLON + module.getName() + NEW_LINE
				+ COURSES + COLON + OPENING_BRACKET + NEW_LINE;
		for (int i = 0; i < module.getCourses().size(); i++) {
			info = info + module.getCourses().get(i).getName() + NEW_LINE;
		}
	...
	public static void printCourseInfo(Course course) {
		String info = COURSE_INFO + NEW_LINE + LINE_BREAK + NEW_LINE + NAME + COLON + course.getName() + NEW_LINE
				+ START_DATE + COLON + course.getStartDate() + NEW_LINE + END_DATE + COLON + course.getEndDate()
				+ NEW_LINE + MODULES + COLON + OPENING_BRACKET + NEW_LINE;
